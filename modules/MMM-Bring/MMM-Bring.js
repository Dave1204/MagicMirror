  ...
  getDom: function () {
    ...
    if (
      ...
      ((!this.currentList.purchase ||
        !this.currentList.purchase.length ||
        this.currentList.purchase.length === 0) &&
    ...
    if (this.currentList && this.currentList.purchase) {
      ...
      for (let i = 0, len = max; i < len; i++) {
        ...
        bringListItem.style =
          "background-color: " + this.config.activeItemColor;
        bringListItem.onclick = () =>
          this.itemClicked({
    ...
    if (
      ...
      for (let i = 0, len = max; i < len; i++) {
        ...
        bringListItem.className = "bring-list-item-content";
        bringListItem.style =
          "background-color: " + this.config.latestItemColor;
        bringListItem.onclick = () =>
          this.itemClicked({
